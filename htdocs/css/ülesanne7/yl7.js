...
function showTemperatureAverage(){
    let monthNumber=1;
...
function highestLowestTemperature(){
    let highestTempMonthNumber, highestTemp = temperatures[0][0];
    let lowestTempMonthNumber, lowestTemp = temperatures [0][0];
...
document.write(`kõrgeim temperatuur on ${getMonthName(highestTempMonthNumber)}${highestTemp}`)
document.write(`madalaim temperatuur on ${getMonthName(lowestTempMonthNumber)}${lowestTemp}`)
}